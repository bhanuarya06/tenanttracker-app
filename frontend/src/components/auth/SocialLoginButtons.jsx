...
import { initiateOAuthFlow, getAvailableProviders } from '../../services/oauthService';
        ...
        {available.map((provider) => {
          ...
          return (
            <button
              ...
              className={`flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg font-medium text-sm transition-colors ${ui.bg} ${ui.text} disabled:opacity-50 disabled:cursor-not-allowed`}
            >
              {isLoading ? (
